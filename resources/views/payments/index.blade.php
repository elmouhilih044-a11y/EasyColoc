...
<div class="p-8 min-h-screen" style="background-color: #F5F0A0;">
    ...
    <h1 class="text-3xl font-bold mb-6" style="color: #4A1040;">Paiements</h1>
        ...
        <table class="w-full">
            <thead style="background-color: #4A1040; color: #F5F0A0;">
                <tr>
                    ...
                    <th class="p-3 text-left">Payeur</th>
                    <th class="p-3 text-left">Receveur</th>
            ...
            <tbody>
                ...
                <tr style="background-color: white; border-bottom: 1px solid #D4894A;">
                    ...
                    <td class="p-3">{{ $payment->payed_date }}</td>
                    <td class="p-3">{{ $payment->payer->name }}</td>
                    <td class="p-3">{{ $payment->receiver->name }}</td>
